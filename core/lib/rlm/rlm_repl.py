...
from core.lib.rlm import RLM
from core.lib.rlm.repl import REPLEnv
from core.lib.rlm.utils.llm import OpenAIClient
from core.lib.rlm.utils.prompts import DEFAULT_QUERY, next_action_prompt, build_system_prompt
import core.lib.rlm.utils.utils as utils

from core.lib.rlm.logger.root_logger import ColorfulLogger
from core.lib.rlm.logger.repl_logger import REPLEnvLogger
...
class RLM_REPL(RLM):
    ...
    def setup_context(self, context: Union[List[str], str, List[Dict[str, str]]], query: Optional[str] = None):
        """
    ...
    def completion(self, context: Union[List[str], str, List[Dict[str, str]]], query: Optional[str] = None) -> str:
        """
